...
> OpenTelemetry instrumentation scripts logging search latencies directly to Jaeger tracing backends.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/tracerag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-tracerag.git
cd tp-tracerag
```
...
```bash
kubectl port-forward deployment/tp-tracerag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── opentelemetry_traces.py     # Main configuration file
```
...
---
*Generated by [TraceRAG Studio](https://pradeeptalari14.github.io/portfolio/tools/tracerag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
